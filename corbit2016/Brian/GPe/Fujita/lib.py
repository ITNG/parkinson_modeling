...
def simulate_GPe_cell(par, par_sim):
	...
	betas_Nap = 1/mV*(6.94e-6 * vg + 4.47e-4*mV)/(1.0 - exp((vg + 64.41*mV)/(-2.63*mV))) :1
	...
	tauh_Kv4s = 50*ms + (71*ms)/(exp((-83*mV - vg)/(10*mV)) + exp((-83*mV - vg)/(-10.*mV))) :second
    ...
    membrain_Im = Iapp-iNaf-iNap-iLeak-iNap-iKv2-iKv3-iKv4f
                  -iKv4s-iKcnq-iHcn-iCah-iSk :amp
